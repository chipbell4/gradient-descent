...
describe('gradient-descent', function() {
  it('should converge to a local minimum of a quadratic', function() {
    ...
    var result = gradientDescent(F, { maxSteps: 1000, gamma: 0.01, initialValue: [0, 0], precision: (0.00001 * 0.00001) });
  ...
  it('should stop if its already close', function() {
    var F = vector => Math.pow(vector[0] - 0.5, 2) + Math.pow(vector[1] - 0.7, 2);
    var result = gradientDescent(F, { maxSteps: 1000000, gamma: 0.01, initialValue: [0.5, 0.7] });
